...
program
  ...
  .option('-s, --stops <percentages...>', 'Gradient percentage stops used to categorize elevation (comma-separated, e.g., "0 15 20 25 30 35 40")', (val, r) => r.concat(parseInt(val)), [])
  .option('-c, --colors <colors...>', 'CSS Colors used to render elevation categories (comma-separated, e.g., "green yellow orange red purple brown black"). Number of elements must match `stops`.')
